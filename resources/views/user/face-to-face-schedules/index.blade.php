                    ...
                    <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden"
                        ...
                        <div class="flex items-center justify-between gap-4 px-6 py-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors"
                            ...
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">
                                        ...
                                        &middot; <span class="text-indigo-600 dark:text-indigo-400">{{ $schedule->sessions->count() }} sesi</span>
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3 shrink-0">
                                ...
                                @else
                                    <span class="inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[11px] font-semibold bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                                    ...
                                    @foreach ($schedule->sessions as $session)
                                        <div class="flex items-center gap-4 px-6 py-3">
                                            ...
                                            <div class="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-1 text-sm">
                                                <span class="font-medium text-gray-800 dark:text-gray-100">{{ $session->name }}</span>
