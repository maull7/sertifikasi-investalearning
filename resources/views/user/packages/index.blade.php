...
@section('content')
    <div class="space-y-8 pb-20">
        ...
        <div class="flex flex-col md:flex-row gap-4">
            <form action="{{ route('user.packages.index') }}" method="GET"
                ...
                <div class="relative flex-1 group">
                    ...
                    @if (request('search'))
                        <a href="{{ route('user.packages.index', request()->except('search')) }}"
                ...
                <div class="w-full md:w-64">
                    <x-select name="id_type" inline class="h-12">
                ...
                {{-- BUTTON --}}
                <div class="flex">
                    <x-button type="submit" variant="primary" class="h-12 px-6 rounded-xl w-full md:w-auto">
                        Terapkan
                    </x-button>
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-2">
                                @if (in_array($package->id, $joinedPackageIds))
                                    ...
                                    @endif
                                @else
                                    <x-button variant="primary" href="{{ route('user.packages.show', $package) }}"
