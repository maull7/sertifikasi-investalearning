    ...
    <x-card>
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                ...
                <div class="text-center">
                    <p class="text-2xl font-bold text-violet-600 dark:text-violet-400">{{ $exam->passing_grade ?? 0 }}%</p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            @if($question->type)
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-[11px] font-medium bg-gray-50 text-gray-700 dark:bg-gray-800 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            <div class="md:col-span-1">
                                <div class="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200/70 dark:border-emerald-500/40">
                                    <p class="text-[11px] font-semibold uppercase tracking-[0.14em] text-emerald-700 dark:text-emerald-300 mb-1">
                                        Kunci Jawaban
                                    </p>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                @if($question->explanation)
                                    <div class="p-4 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
                                        <p class="text-[11px] font-semibold uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400 mb-1">
                                            Penjelasan
                                        </p>
                                ...
                                @if($question->solution)
                                    <div class="p-4 rounded-2xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/40">
                                        <p class="text-[11px] font-semibold uppercase tracking-[0.14em] text-indigo-600 dark:text-indigo-300 mb-1">
                                            Solusi
                                        </p>
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-100 dark:border-gray-800">
                @if($detailResults->onFirstPage())
                    <x-button
                        variant="secondary"
                        disabled
                        class="rounded-xl opacity-40 cursor-not-allowed">
                        <i class="ti ti-arrow-left mr-2"></i> Sebelumnya
                    </x-button>
                @else
                    <x-button
                        variant="secondary"
                        href="{{ $detailResults->previousPageUrl() }}"
                        class="rounded-xl">
                        <i class="ti ti-arrow-left mr-2"></i> Sebelumnya
                    </x-button>
                @endif
                ...
                @else
                    <x-button
                        variant="secondary"
                        href="{{ $detailResults->nextPageUrl() }}"
                        class="rounded-xl">
                        Selanjutnya <i class="ti ti-arrow-right ml-2"></i>
                    </x-button>
                @endif
