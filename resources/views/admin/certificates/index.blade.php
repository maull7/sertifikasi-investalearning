    ...
    <div class="space-y-6 pb-20">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <x-button variant="primary" href="{{ route('certificates.create') }}" class="rounded-xl">
                <i class="ti ti-plus mr-2"></i> Buat Sertifikat
            </x-button>
        </div>

        <x-card :padding="false" title="Daftar Sertifikat">
                        ...
                        @forelse($certificates as $certificate)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors">
                                ...
                                <td class="py-3 px-4 sm:px-6 text-center">
                                    <x-button variant="primary" size="sm" href="{{ route('certificates.show', $certificate) }}"
