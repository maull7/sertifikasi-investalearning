                        ...
                        <div
                            ...
                            <div class="flex-1 flex flex-col md:flex-row gap-3 md:items-center">
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    Jenis paket: <span
                                        class="font-semibold text-gray-900 dark:text-white">{{ $package->masterType->name_type ?? '-' }}</span>.
                                    Pilih mapel di bawah lalu tambah ke paket.
                                </div>
                                <x-button type="button" variant="secondary" class="rounded-xl"
                                    href="{{ route('mapping-package.manage', $package) }}">
                                    Reset
                                </x-button>
                            </div>
                        </div>
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            Anda akan menghapus mapel <span class="font-bold text-gray-900 dark:text-white"
                                x-text="subjectName"></span> dari paket. Tindakan ini tidak dapat dibatalkan.
                        </p>
                    </div>
                    <div
