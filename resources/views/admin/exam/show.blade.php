        ...
        <x-card title="Informasi Ujian">
            <div class="space-y-6">
                ...
                <div
                    ...
                    <div class="md:w-1/3">
                        <span
                            class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Paket</span>
                    </div>
                    <div class="md:w-2/3">
                        <span
                ...
                <div
                    class="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-6 border-b border-gray-50 dark:border-gray-800">
                    <div class="md:w-1/3">
                        <span class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Mata
                            Pelajaran</span>
                    </div>
                    <div class="md:w-2/3">
                        <span
                ...
                <div
                    class="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-6 border-b border-gray-50 dark:border-gray-800">
                    <div class="md:w-1/3">
                        <span class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Judul
                            Ujian</span>
                    </div>
                    <div class="md:w-2/3">
                ...
                @if ($data->description)
                    <div
                        class="flex flex-col md:flex-row md:items-start gap-2 md:gap-4 pb-6 border-b border-gray-50 dark:border-gray-800">
                        <div class="md:w-1/3">
                            <span
                                class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Deskripsi</span>
                        </div>
                        <div class="md:w-2/3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pb-6 border-b border-gray-50 dark:border-gray-800">
                    <div>
                        <span
                            class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider block mb-3">Durasi</span>
                        <div class="flex items-center gap-2">
                            <div
                                class="w-12 h-12 bg-amber-50 dark:bg-amber-500/10 rounded-xl flex items-center justify-center">
                    ...
                    <div>
                        <span
                            class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider block mb-3">Jumlah
                            Soal</span>
                        <div class="flex items-center gap-2">
                    ...
                    <div>
                        <span
                            class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider block mb-3">Nilai
                            Kelulusan</span>
                        <div class="flex items-center gap-2">
                            <div
                                class="w-12 h-12 bg-green-50 dark:bg-green-500/10 rounded-xl flex items-center justify-center">
