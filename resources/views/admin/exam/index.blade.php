...
<div class="space-y-8 pb-20" x-data="{
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <x-button variant="primary" href="{{ route('exams.create') }}" icon="plus" class="rounded-xl shadow-lg shadow-indigo-500/20">
                Tambah Ujian Baru
            </x-button>
        </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-4">
        <form action="{{ route('exams.index') }}" method="GET" class="relative flex-1 group">
            ...
            >
            @if(request('search'))
                <a href="{{ route('exams.index') }}" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-rose-500 transition-colors">
                    <i class="ti ti-x"></i>
                </a>
            @endif
        </form>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors group">
                            ...
                            <td class="py-4 px-8">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <x-button variant="secondary" size="sm" href="{{ route('exams.edit', $value->id) }}" class="rounded-lg h-9 w-9 p-0 flex items-center justify-center">
        ...
        <div class="bg-white dark:bg-gray-900 w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-800"
            ...
            <div class="p-8 text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                    Anda akan menghapus ujian <span class="font-bold text-gray-900 dark:text-white" x-text="examTitle"></span>. Tindakan ini tidak dapat dibatalkan.
                </p>
            </div>
