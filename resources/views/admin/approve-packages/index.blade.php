...
@section('content')
    <div class="space-y-8 pb-20" x-data="{
        ...
        <form action="{{ route('approve-packages.index') }}" method="GET" class="relative max-w-xl">
            ...
            @if (request('search'))
                <a href="{{ route('approve-packages.index') }}"
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="border-b border-gray-50 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30">
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Nama
                                    Peserta</th>
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Email
                                </th>
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Paket
                                    yang ingin di ikuti</th>
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Jadwal
                                </th>
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Bukti
                                    Transfer</th>
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Waktu
                                    Submit</th>
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Status
                                </th>
                                <th
                                    class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider text-right">
                                    Aksi</th>
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                            @forelse ($data as $value)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors group">
                                    ...
                                    <td class="py-4 px-8 text-sm font-medium text-gray-900 dark:text-white">
                                        {{ $value->user->name }}</td>
                                    <td class="py-4 px-8 text-sm text-gray-500 dark:text-gray-400">
                                        {{ $value->user->email }}</td>
                                    <td class="py-4 px-8 text-sm text-gray-700 dark:text-gray-300">
                                        {{ $value->package->title }}</td>
                                    <td class="py-4 px-8 text-sm text-gray-500 dark:text-gray-400">
                                        {{ $value->schedule?->title ?? '-' }}</td>
                                        ...
                                        <div
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                                    ...
                                                    @else
                                                        Sepertinya data jenis Anda masih kosong. Mulai tambahkan data baru
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="border-b border-gray-50 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30">
                                ...
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Jenis
                                </th>
                                <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Jumlah
                                    Peserta</th>
                                <th
                                    class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider text-right">
                                    Aksi</th>
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                            @forelse ($activePackages as $pkg)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors group">
                                    <td class="py-4 px-8 font-medium text-gray-900 dark:text-white">{{ $pkg->title }}
                                    </td>
                                    <td class="py-4 px-8 text-sm text-gray-600 dark:text-gray-400">
                                        {{ $pkg->masterType->name_type ?? '-' }}</td>
                                    <td class="py-4 px-8">
                                        <span
                                            class="inline-flex items-center justify-center px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300">
                                    ...
                                    <td class="py-4 px-8">
                                        <div class="flex items-center justify-end">
                                            <x-button variant="secondary" size="sm"
                                                href="{{ route('approve-packages.package.show', $pkg) }}"
                                                class="rounded-lg">
                                    ...
                                    <td colspan="4" class="py-24">
                                        <div
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed mt-1">
                                                ...
                                                @else
                                                    Paket dengan status aktif akan muncul di sini.
                                                @endif
                                            </p>
                                        </div>
                                    </td>
            ...
            <div class="bg-white dark:bg-gray-900 w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-800"
                ...
                <div class="p-8 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                        Anda akan menyetujui <span class="font-bold text-gray-900 dark:text-white"
                            x-text="userName"></span> untuk mengikuti paket <span x-text="paket"></span>. Tindakan ini
        ...
        <div x-show="rejectModal"
            ...
            <div class="bg-white dark:bg-gray-900 w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-800"
                ...
                <div class="p-8 text-center">
                    <div
                        class="w-20 h-20 bg-red-50 dark:bg-red-500/10 text-red-500 rounded-3xl flex items-center justify-center mx-auto mb-6">
                        <i class="ti ti-circle-dashed-x text-4xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Tolak Pengguna ?</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                        Anda akan menolak <span class="font-bold text-gray-900 dark:text-white" x-text="userName"></span>
                        untuk mengikuti paket <span x-text="paket"></span>. Tindakan ini tidak dapat dibatalkan.
                    </p>
                </div>
