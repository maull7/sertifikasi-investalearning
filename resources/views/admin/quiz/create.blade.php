...
@section('content')
    <div class="max-w-5xl mx-auto space-y-8 pb-20">
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-1">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Tambah Kuis Baru</h1>
            ...
            <form action="{{ route('quizzes.store') }}" method="POST" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="4" placeholder="Masukkan deskripsi Kuiss..."
