...
@section('content')
    <div class="max-w-5xl mx-auto space-y-8 pb-20">
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-1">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Edit Kuis</h1>
        ...
        {{-- Form Card --}}
        <x-card title="Edit Data Kuis">
            <form action="{{ route('quizzes.update', $data->id) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Title --}}
                    <div class="md:col-span-2">
                        <x-input label="Judul Kuis" name="title" placeholder="Masukkan judul Kuis"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="4" placeholder="Masukkan deskripsi Kuis..."
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Durasi Kuis dalam menit</p>
                    </div>
                    ...
                    {{-- Total Questions --}}
                    <div>
                        <x-input label="Jumlah Soal Kuis (Opsional)" name="total_questions" type="number" min="1"
                            placeholder="Contoh: 50" value="{{ old('total_questions', $data->total_questions) }}" />
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Isi jumlah soal yang direncanakan untuk Kuis ini (boleh dikosongkan).
                        </p>
                    </div>
                </div>
