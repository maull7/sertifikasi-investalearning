...
<div class="space-y-8 pb-20" x-data="{ 
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <x-button variant="secondary" href="{{ route('master-packages.download-template') }}" icon="plus" class="rounded-xl shadow-lg shadow-indigo-500/20">
                Download Paket
            </x-button>
            <x-button variant="success" @click="ModalPaket = true" icon="plus" class="rounded-xl shadow-lg shadow-indigo-500/20">
              Import Paket
            </x-button>
        ...
        <div class="bg-white dark:bg-gray-900 w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-800"
            ...
            <form action="{{ route('master-packages.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-8">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2 text-center">Import Paket dari Excel</h3>
                ...
                <div class="flex gap-3 p-6 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-800">
                    <x-button variant="secondary" type="button" class="flex-1 rounded-xl" @click="ModalPaket = false">
                        Batal
                    </x-button>
