...
<div class="max-w-5xl mx-auto space-y-8 pb-20">
    ...
    <div class="flex items-center justify-between">
        <div class="space-y-1">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Tambah Soal</h1>
    ...
    {{-- Form Card --}}
    <x-card title="Soal Baru">
        <form action="{{ route('bank-questions.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <label class="flex items-center gap-3 p-4 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 cursor-pointer">
                            <input type="radio" name="question_type" value="Text" class="accent-indigo-600" {{ old('question_type', 'Text') === 'Text' ? 'checked' : '' }}>
                        ...
                        <label class="flex items-center gap-3 p-4 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 cursor-pointer">
                            <input type="radio" name="question_type" value="Image" class="accent-indigo-600" {{ old('question_type') === 'Image' ? 'checked' : '' }}>
                            <div class="flex items-center gap-2">
                ...
                <div class="md:col-span-2" id="question-text-section">
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        <div id="editor-question" class="dark:text-white">{!! old('question') !!}</div>
                    </div>
                    <input type="hidden" name="question" id="question" value="{{ old('question') }}">
                    @error('question')
                        <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2 mb-16">
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        <div id="editor-solution" class="dark:text-white">{!! old('solution') !!}</div>
                    </div>
                    <input type="hidden" name="solution" id="solution" value="{{ old('solution') }}">
                    @error('solution')
                        <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2 mb-16">
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        <div id="editor-explanation" class="dark:text-white">{!! old('explanation') !!}</div>
                    </div>
