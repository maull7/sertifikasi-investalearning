...
<div class="space-y-8 pb-20" x-data="{ 
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <x-button variant="primary" href="{{ route('bank-questions.create') }}" icon="plus" class="rounded-xl shadow-lg shadow-indigo-500/20">
                Tambah Soal Baru
            </x-button>
        </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-4">
        <form action="{{ route('bank-questions.index') }}" method="GET" class="relative flex-1 group">
                    ...
                    @forelse ($data as $value)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors group">
                            ...
                            <td class="py-4 px-8 text-center">
                                <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-400 font-bold text-sm">
                                    {{ strtoupper($value->answer) }}
                                </span>
                            </td>
                            <td class="py-4 px-8">
                                <div class="flex items-center justify-end gap-2">
                                    <x-button variant="secondary" size="sm" href="{{ route('bank-questions.edit', $value->id) }}" class="rounded-lg h-9 w-9 p-0 flex items-center justify-center">
