        ...
        <div class="space-y-6">
            ...
            <div class="pb-6 border-b border-gray-50 dark:border-gray-800">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-center gap-3 p-4 rounded-2xl {{ strtolower($data->answer) === 'a' ? 'bg-green-50 dark:bg-green-500/10 border-2 border-green-500' : 'bg-gray-50 dark:bg-gray-900/50' }}">
                        <div class="w-10 h-10 rounded-xl {{ strtolower($data->answer) === 'a' ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300' }} flex items-center justify-center font-bold text-sm">
                            A
                        </div>
                    ...
                    <div class="flex items-center gap-3 p-4 rounded-2xl {{ strtolower($data->answer) === 'b' ? 'bg-green-50 dark:bg-green-500/10 border-2 border-green-500' : 'bg-gray-50 dark:bg-gray-900/50' }}">
                        <div class="w-10 h-10 rounded-xl {{ strtolower($data->answer) === 'b' ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300' }} flex items-center justify-center font-bold text-sm">
                            B
                        </div>
                    ...
                    <div class="flex items-center gap-3 p-4 rounded-2xl {{ strtolower($data->answer) === 'c' ? 'bg-green-50 dark:bg-green-500/10 border-2 border-green-500' : 'bg-gray-50 dark:bg-gray-900/50' }}">
                        <div class="w-10 h-10 rounded-xl {{ strtolower($data->answer) === 'c' ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300' }} flex items-center justify-center font-bold text-sm">
                            C
                        </div>
                    ...
                    <div class="flex items-center gap-3 p-4 rounded-2xl {{ strtolower($data->answer) === 'd' ? 'bg-green-50 dark:bg-green-500/10 border-2 border-green-500' : 'bg-gray-50 dark:bg-gray-900/50' }}">
                        <div class="w-10 h-10 rounded-xl {{ strtolower($data->answer) === 'd' ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300' }} flex items-center justify-center font-bold text-sm">
                            D
                        </div>
