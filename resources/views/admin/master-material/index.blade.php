    ...
    <div class="space-y-8 pb-20" x-data="{
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <x-button variant="primary" href="{{ route('master-materials.create') }}" icon="plus"
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-gray-50 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30">
                            ...
                            <th class="py-4 px-8 text-[11px] font-bold uppercase text-gray-400 tracking-wider">Jenis Materi
                            </th>
                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                        @forelse ($data as $value)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors group">
                                ...
                                <td class="py-4 px-8">
                                    <div class="max-w-xs">
                                        <p class="text-sm text-gray-900 dark:text-white font-semibold mb-1">
                                            {{ $value->title }}</p>
                                        <button type="button"
                                            @click="showPreview('{{ $value->title }}', `{!! addslashes($value->description ?? '') !!}`)"
                                ...
                                <td class="py-4 px-8">
                                    ...
                                    @else
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-300">
                                            Link Video
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td class="py-4 px-8">
                                    <div class="flex items-center justify-end gap-2">
                                        <x-button variant="secondary" size="sm"
                                            href="{{ route('master-materials.edit', $value->id) }}"
                                    ...
                                    <div
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                                ...
                                                @else
                                                    Sepertinya data material Anda masih kosong. Mulai tambahkan data baru
                                        ...
                                        <div class="mt-6">
                                            ...
                                            @else
                                                <x-button variant="secondary"
                                                    href="{{ route('master-materials.create') }}">
