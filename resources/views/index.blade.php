...
<head>
    ...
    <style>
        ...
        @keyframes wa-float {
            0%, 100% { transform: translateY(0) scale(1); box-shadow: 0 10px 40px -10px rgba(37, 211, 102, 0.5); }
            50% { transform: translateY(-8px) scale(1.05); box-shadow: 0 20px 50px -10px rgba(37, 211, 102, 0.6); }
        }
        .animate-wa-float { animation: wa-float 2.5s ease-in-out infinite; }
        @keyframes morph {
